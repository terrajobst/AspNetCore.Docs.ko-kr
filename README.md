...
이 리포지토리에는 [docs.microsoft.com/aspnet/core](https://docs.microsoft.com/aspnet/core)에서 호스트되는 ASP.NET Core 문서의 개념 설명서가 포함되어 있습니다. 이 설명서에 참여하려면 [참여 가이드](CONTRIBUTING.md) 및 [문제 목록](https://github.com/aspnet/Docs/issues)을 참조하세요.

API 문서에 대한 변경 내용은 [ApiDocs 리포지토리](https://github.com/aspnet/ApiDocs)에서 슬래시 세 개(`///`) 주석으로 작성됩니다.

ASP.NET 4.x 문서의 변경 내용은 [aspnet/AspNetDocs 리포지토리](https://github.com/aspnet/AspNetDocs)에서 작성합니다.
