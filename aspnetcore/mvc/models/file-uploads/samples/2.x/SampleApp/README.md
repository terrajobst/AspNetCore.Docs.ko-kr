# <a name="upload-files-sample-app"></a><span data-ttu-id="8a56a-101">파일 업로드 샘플 앱</span><span class="sxs-lookup"><span data-stu-id="8a56a-101">Upload Files Sample App</span></span>
