...
A *공유 프레임 워크* 어셈블리의 집합이 (*.dll* 파일) 앱의 폴더에 없는 합니다. 공유 프레임 워크는 앱을 실행 하려면 컴퓨터에 설치 되어야 합니다. 자세한 내용은 [공유 프레임 워크](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/)합니다.
