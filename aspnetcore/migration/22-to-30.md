...
### <a name="systemruntimeserialization-attributes-not-supported"></a>지원 되지 않는 system.object 특성

[[DataContract]](xref:System.Runtime.Serialization.DataContractAttribute) 및 [[DataMember]](xref:System.Runtime.Serialization.DataMemberAttribute) 특성은 `System.Text.Json`에서 지원 되지 않습니다. 자세한 내용은 GitHub에 대 한 GitHub 문제 [지원](https://github.com/dotnet/corefx/issues/38758)을 참조 하세요.
