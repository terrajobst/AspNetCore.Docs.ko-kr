...
@No__t_0에서 `HostBuilder`로의 가장 중요 한 변경 내용은 [DI (종속성 주입)](xref:fundamentals/dependency-injection)에 있습니다. @No__t_0를 사용 하는 경우 <xref:Microsoft.Extensions.Configuration.IConfiguration> 및 <xref:Microsoft.AspNetCore.Hosting.IHostingEnvironment>를 `Startup`의 생성자에만 삽입할 수 있습니다. @No__t_0 DI 제약 조건:
