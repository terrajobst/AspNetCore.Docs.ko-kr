...
* Entity Framework Core-데이터베이스 https://docs.microsoft.com/ef/core/providers/index 공급자별 패키지를 참조 하는 방법에 대 한 자세한 내용은을 참조 하십시오.

* Id [ui](xref:security/authentication/identity) 에 대 한 Id Ui 지원은 [AspNetCore](https://www.nuget.org/packages/Microsoft.AspNetCore.Identity.UI) 패키지를 참조 하 여 추가할 수 있습니다.
...
* 인증-타사 인증 흐름에 대 한 지원은 NuGet 패키지로 제공 됩니다.
    ...
    * [Openid connect 연결 전달자 토큰](https://www.nuget.org/packages/Microsoft.AspNetCore.Authentication.JwtBearer)
    * [Microsoft 계정 인증](https://www.nuget.org/packages/Microsoft.AspNetCore.Authentication.MicrosoftAccount)
    * [Openid connect Connect 인증](https://www.nuget.org/packages/Microsoft.AspNetCore.Authentication.OpenIdConnect)
    * [Twitter OAuth](https://www.nuget.org/packages/Microsoft.AspNetCore.Authentication.Twitter)
    * [WsFederation 인증](https://www.nuget.org/packages/Microsoft.AspNetCore.Authentication.WsFederation)

* `System.Net.HttpClient` 에 대 한 형식 지정 및 콘텐츠 협상 지원- [WebApi](https://www.nuget.org/packages/Microsoft.AspNet.WebApi.Client/) NuGet 패키지는 등의 api `System.Net.HttpClient` `ReadAsAsync` `PostJsonAsync` 를 사용 하 여에 유용한 확장성을 제공 합니다.

* Razor 런타임 컴파일-Razor 뷰 및 페이지의 런타임 컴파일에 대 한 지원은 이제 AspNetCore의 일부입니다. [RuntimeCompilation](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Razor.RuntimeCompilation).

* Mvc `Newtonsoft.Json` 지원-이제에서 `Newtonsoft.Json` mvc 사용에 대 한 지원이 AspNetCore의 일부입니다. [NewtonsoftJson](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.NewtonsoftJson).
...
AspNetCore의 ASP.NET Core 2.2 및 `AddAuthorization` 하위 메서드 는 다음과 같습니다.
...
ASP.NET Core 3.0 릴리스의 추가 주요 변경 내용은 [aspnet/알림 리포지토리](https://github.com/aspnet/Announcements/issues?page=2&q=is%3Aissue+is%3Aopen+label%3A%22Breaking+change%22+label%3A3.0.0)를 참조 하세요. .NET Core, ASP.NET Core 및 Entity Framework Core 전체에서 2.2-3.0의 주요 변경 내용에 대 한 요약은 [버전 2.2에서 3.0로 마이그레이션에 대 한 주요 변경 내용](/dotnet/core/compatibility/2.2-3.0)을 참조 하세요.
