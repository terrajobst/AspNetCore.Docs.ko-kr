...
3\.0에서는 런타임 컴파일은 옵트인 시나리오입니다. 런타임 컴파일 사용 하려면 https://docs.microsoft.com/aspnet/core/mvc/views/view-compilation?view=aspnetcore-3.0#runtime-compilation 합니다.
