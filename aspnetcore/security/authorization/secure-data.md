...
| 사용자                | Seeded by the app | 옵션                                  |
| ------------------- | :---------------: | ---------------------------------------- |
| test@example.com    | 아니요                | Edit/delete the own data.                |
| manager@contoso.com | 예               | Approve/reject and edit/delete own data. |
| admin@contoso.com   | 예               | Approve/reject and edit/delete all data. |
