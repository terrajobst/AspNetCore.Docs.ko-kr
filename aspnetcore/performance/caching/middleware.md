...
응답 캐싱 미들웨어는 ASP.NET Core 앱에 암시적으로 추가 되는 [AspNetCore ResponseCaching](https://www.nuget.org/packages/Microsoft.AspNetCore.ResponseCaching/) 패키지에 의해 사용할 수 됩니다.
