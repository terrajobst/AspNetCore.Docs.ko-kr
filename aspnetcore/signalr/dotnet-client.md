...
## <a name="install-the-opno-locsignalr-net-client-package"></a>SignalR .NET 클라이언트 패키지를 설치 합니다.

[AspNetCoreSignalR입니다. 클라이언트](https://www.nuget.org/packages/Microsoft.AspNetCore.SignalR.Client) 패키지는 .net 클라이언트가 SignalR 허브에 연결 하는 데 필요 합니다.
