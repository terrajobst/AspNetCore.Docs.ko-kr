...
* [InteropComponent 예 (dotnet/AspNetCore GitHub 리포지토리, 3.0 릴리스 분기)](https://github.com/dotnet/AspNetCore/blob/release/3.0/src/Components/test/testassets/BasicTestApp/InteropComponent.razor)
