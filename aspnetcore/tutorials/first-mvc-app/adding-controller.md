...
예제에서 컨트롤러는 MVC의 “VC” 부분, 즉 **V**iew(보기) 및 **C**ontroller(컨트롤러) 작업을 수행했습니다. 컨트롤러는 HTML을 직접 반환합니다. 일반적으로 코드 및 유지 관리가 매우 복잡해지므로 컨트롤러에서 HTML을 직접 반환하지 않으려고 합니다. 대신 별도의 Razor 뷰 템플릿 파일을 사용하여 HTML 응답을 생성합니다. 다음 자습서에서 해당 작업을 수행합니다.
